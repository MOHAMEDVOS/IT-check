...
function App() {
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 text-slate-50 font-sans overflow-x-hidden">
      ...
      {/* Nature image zone – covers header + hero */}
      <div className="relative overflow-hidden">
        {/* Nature image background */}
        <div
          className="absolute inset-0 z-0"
          style={{ backgroundImage: "url(/nature.jpg)", backgroundSize: "cover", backgroundPosition: "center" }}
          aria-hidden
        />
        {/* Dark overlay */}
        <div className="absolute inset-0 z-[1] bg-slate-950/40" aria-hidden />
        {/* Blue gradient overlay */}
        <div className="absolute inset-0 z-[1] bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,_#1d4ed855,_transparent_50%),radial-gradient(ellipse_60%_80%_at_80%_50%,_#1e40af33,_transparent_45%),radial-gradient(ellipse_60%_80%_at_20%_80%,_#0e749033,_transparent_45%)]" aria-hidden />
        {/* Blue glowing orbs */}
        <div className="absolute bottom-0 left-0 z-[2] h-72 w-72 rounded-full bg-blue-600/25 blur-3xl animate-float" aria-hidden />
        <div className="absolute right-0 top-0 z-[2] h-64 w-64 rounded-full bg-cyan-500/20 blur-3xl animate-float" style={{ animationDelay: "1.2s" }} aria-hidden />
        <div className="absolute bottom-0 left-1/2 z-[2] h-48 w-80 -translate-x-1/2 rounded-full bg-blue-500/20 blur-3xl animate-float" style={{ animationDelay: "2.4s" }} aria-hidden />

        <header className="relative z-10 border-b border-white/10 bg-slate-950/30 backdrop-blur-md">
        ...
        <main className="mx-auto max-w-7xl px-5 pb-20 pt-6 md:max-w-[1400px] md:px-8 md:pt-10 xl:max-w-[1600px] xl:px-10">
          {/* Hero – main focus */}
          <section className="relative mb-4 p-3 md:mb-6 md:p-4">
            <div className="relative z-10">
              ...
              >
                <div className="mx-auto max-w-6xl relative overflow-hidden rounded-[24px] border border-white/[0.15] bg-slate-900/90 shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_32px_80px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.15),inset_0_0_20px_rgba(255,255,255,0.05)] backdrop-blur-[40px] transition-all duration-500 hover:border-white/20 hover:bg-slate-900/95">
                  <div className="pointer-events-none absolute inset-0 rounded-[28px] bg-[linear-gradient(180deg,_rgba(255,255,255,0.08)_0%,_rgba(255,255,255,0.02)_20%,_transparent_60%)]" />
                  <div className="pointer-events-none absolute inset-0 rounded-[28px] ring-1 ring-inset ring-white/10" />

                  <div className="relative grid items-center gap-10 px-6 py-8 md:grid-cols-[1.05fr_1fr] md:gap-12 md:px-10 md:py-12 lg:px-12 lg:py-14 xl:gap-14 xl:px-14">
                    ...
                    >
                      ...
                      <div className="relative overflow-hidden rounded-3xl border border-blue-500/35 bg-slate-900/85 p-4 shadow-[0_25px_40px_rgba(0,0,0,0.4),0_0_40px_rgba(59,130,246,0.15)]">
      ...
      </div> {/* End Nature image zone */}

      <main className="mx-auto max-w-7xl px-5 pb-20 md:max-w-[1400px] md:px-8 xl:max-w-[1600px] xl:px-10">
        {/* Features */}
